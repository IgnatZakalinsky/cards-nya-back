...
exports.logIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (validators_1.validateAnswer(req, res, 'logIn')) {
        try {
            ...
            if (!user || !(yield bcrypt_1.default.compare(req.body.password, user.password)))
                ...
                try {
                    ...
                    res.status(500).json({
                        error: 'some error', errorObject: config_1.DEV_VERSION && e, in: 'logIn/User.findByIdAndUpdate'
                    });
                }
            }
        }
            ...
            res.status(500).json({
                error: 'some error', errorObject: config_1.DEV_VERSION && e, in: 'logIn/User.findOne'
            });
        }
    }
});
